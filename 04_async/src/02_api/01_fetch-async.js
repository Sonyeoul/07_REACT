...
/*
    ...
    과거에는 ajax를 이용해 페이지 새로고침 없이 (비동기)
    서버에 데이터를 가져올 수 있었다
    
    fetch는 ajax 의 단점을 개선하고 좀더 현대적인 방식으로
    네트워크 요청을 처리할 수 있게 해준다
    따라서 최신 웹 어플리케이션은 fetch를 사용하는 것을 권장한다.
...
<<<<<<< HEAD
    ...
    /* 
        JSON javascriopt object notation 은 데이터를
...
=======
    ...
    /*
        ...
        구조화하여 교환하기 위한 경량 데이터 형식이다..
        사람과 기계 모두 읽고 쓰기 쉽게 설계되어 있으며
        주로 웹 어플리케이션에서 서버와 클라이언트 사이의 데이터 전송에
        사용된다.. 
>>>>>>> 6f575384880afb77d48bb9566394499e392857aa
        특징으로는
        1. 텍스트 기반의 형식
